package edu.dartmouth.cs.donewithreceipt.uicamera;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public static abstract class Graphic {
        ...
        /**
         * Returns the text on the position
         */
        public abstract String getText(float x, float y);
    ...
    /**
     * Returns the first text, if any, that exists at the provided absolute screen coordinates.
     ...
     */
    public String getTextAtLocation(float rawX, float rawY) {
        synchronized (mLock) {
            ...
            for (T graphic : mGraphics) {
                if (graphic.contains(rawX - location[0], rawY - location[1])) {
                    return graphic.getText(rawX - location[0], rawY - location[1]);
                }
            }
            return null;
        }
